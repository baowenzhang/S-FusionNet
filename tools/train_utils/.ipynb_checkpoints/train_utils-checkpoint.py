...
def train_model(model, optimizer, train_loader, test_loader, args, cfg, model_func, lr_scheduler, optim_cfg,
...
#                 with torch.no_grad():
#                     ret_dict = eval_single_ckpt(cfg, model, test_loader, args, ckpt_save_dir, logger, trained_epoch)
                    
#                 if len(cfg.CLASS_NAMES) == 3:
#                     mAP = (ret_dict['Car_3d/moderate_R40'] + ret_dict['Pedestrian_3d/moderate_R40'] + ret_dict['Cyclist_3d/moderate_R40']) / 3
#                 else:
#                     mAP = ret_dict['Car_3d/moderate_R40']
