...
if __name__ == '__main__':
    ...
    if args.func == 'create_waymo_infos':
        ...
        create_waymo_infos(
            ...
            data_path=Path('/data-ws-nfs/datasets/waymo_processed').resolve(), #ROOT_DIR / 'data' / 'waymo',
            save_path=Path('/data-ws-nfs/datasets/waymo_processed').resolve(), #ROOT_DIR / 'data' / 'waymo',
